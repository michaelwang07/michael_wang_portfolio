  ...
  return (
    <div className='app__intro section__padding'>
      <div className='app__intro-description'>
        ...
        <p className='paragraph-1'>Junior developers typically have lower salary expectations than more epxerienced develpers, making them a cost-effective option for your company</p>
